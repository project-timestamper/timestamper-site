...
Our new timestamps cover the full public collection of assembled genome sequences from the [database](https://www.ncbi.nlm.nih.gov/datasets/genome/) maintained by the National Center for Biotechnology Information (NCBI), run by the US National Institutes of Health. These sequences were generated by the work of thousands of researchers in scientific labs around the world over the past couple of decades, using techniques to extract, purify and fragment DNA from cells, machines that run large-scale sequencing of those DNA fragments, and software that took the resulting short sequence fragments and assembled them into the sequences of whole chromosomes and genomes.
